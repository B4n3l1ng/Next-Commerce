...
export default function AuthForm({ mode }: Props) {
  return (
    <>
      ...
      <form className="flex flex-col w-1/2 mx-auto bg-slate-700 p-5 text-white justify-between min-h-[33vh]">
        <div className="flex flex-col flex-1 justify-center">
          <div className="flex flex-row w-full justify-between items-center mb-3">
            <label htmlFor="email" className="w-1/3">
              Email
            </label>
            <input type="text" name="email" id="email" required className="w-2/3 border-solid border-blue border-2 rounded-md" />
          </div>
          {mode === 'signup' && (
            <div className="flex flex-row w-full justify-between items-center mb-3">
              ...
              <input type="text" name="name" id="name" required className="w-2/3 border-solid border-blue border-2 rounded-md" />
            </div>
          )}
          <div className="flex flex-row w-full justify-between items-center mb-3">
            ...
            <input type="password" name="password" id="password" className="w-2/3 border-solid border-blue border-2 rounded-md" />
          </div>
        </div>
